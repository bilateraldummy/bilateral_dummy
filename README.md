...
# Instructions
In order to run the experiments, first download the supplemental material, then from a terminal in the relevant folder, run `chmod +x /run_experiments.sh` followed by `./run_experiments.sh`.
