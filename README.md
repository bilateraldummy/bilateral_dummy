...
# Instructions
In order to run the experiments, first download the [supplemental material](https://openreview.net/forum?id=B1pHQZS5LO&referrer=%5Bthe+profile+of+Dominic+Broadbent%5D%28%2Fprofile%3Fid%3D%7EDominic_Broadbent1%29), then from a terminal in the relevant folder, run `chmod +x /run_experiments.sh` followed by `./run_experiments.sh`.
...
```
  ...
  compressed_set.coreset.data # This should contain 10 data points in 2 dimensions
```
